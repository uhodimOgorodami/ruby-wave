# фича на определение треугольника прямым, опционально равнобедренным и равносторонним
...
if
	...
	puts "Тип треугольника - прямой"
elsif
	(a == b && b != c) || (b == c && b != a)
	puts "Тип треугольника - прямой, также он еще и равнобедренный"
elsif 
	a == b && b == c && c == a
	puts "Это не прямой треугольник, тем не менее треугольник равнобедренный и равносторонний"
else
  puts "Это не прямой треугольник"
end